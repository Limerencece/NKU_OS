...
#define PDX1(la) ((((uintptr_t)(la)) >> PDX1SHIFT) & 0x1FF) // 顶层页目录索引
#define PDX0(la) ((((uintptr_t)(la)) >> PDX0SHIFT) & 0x1FF) // 中间页目录索引

// page table index
#define PTX(la) ((((uintptr_t)(la)) >> PTXSHIFT) & 0x1FF) // 页表索引

// page number field of address
#define PPN(la) (((uintptr_t)(la)) >> PTXSHIFT) // 物理页号

// offset in page
#define PGOFF(la) (((uintptr_t)(la)) & 0xFFF) // 页内偏移
