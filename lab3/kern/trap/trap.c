 ...
 */
void idt_init(void) {
    /* LAB3 2312326 范鼎辉 2311136 崔颖欣 2312585 解子萱  : STEP 2 */
    ...
    switch (cause) {
        ...
        case IRQ_S_TIMER:
            ...
            // cprintf("Supervisor timer interrupt\n");
             /* LAB3 EXERCISE1   2312326 范鼎辉 2311136 崔颖欣 2312585 解子萱  :  */
...
void exception_handler(struct trapframe *tf) {
    switch (tf->cause) {
        ...
        case CAUSE_BREAKPOINT:
            //断点异常处理
            /* LAB3 CHALLLENGE3   2312326 范鼎辉 2311136 崔颖欣 2312585 解子萱  :  */
